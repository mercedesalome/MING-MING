...
// Read and trim Stripe secret key from environment
...
console.log("Stripe key detected (masked):", stripeKey.substring(0, 8) + "...");
...
app.post('/api/subscription/create', async (req, res) => {
    try {
        ...
        const priceId = planType === 'yearly'
            ? process.env.YEARLY_PRICE_ID?.trim()
            : process.env.MONTHLY_PRICE_ID?.trim();
